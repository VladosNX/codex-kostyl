...
#sectionLabel { color: #737873; font-size: 10px; font-weight: 700; padding: 10px 8px 1px 8px; }
...
#projectCombo::drop-down, #optionCombo::drop-down { border: 0; width: 18px; }
...
#chatContext { color: #737873; font-size: 11px; }
...
#contextUsageLabel { color: #858b86; font-size: 10px; }
...
#weeklyLimitLabel { color: #818681; font-size: 10px; }
...
#turnDuration { color: #727a74; font-size: 10px; padding: 1px 5px 5px 5px; }
...
#activityGroupTitle { background: transparent; border: 0; color: #777d78; font-size: 9px; font-weight: 700; letter-spacing: 1px; padding: 10px 13px 8px 13px; text-align: left; }
...
#executionPlanTitle { color: #7f9186; font-size: 9px; font-weight: 700; letter-spacing: 1px; }
...
#emptyDescription { color: #777c77; font-size: 13px; }
...
#queueTitle { color: #969c97; font-size: 10px; font-weight: 700; letter-spacing: 1px; }
...
#queueItemButton { background: transparent; border: 0; color: #b9bdb9; padding: 5px 7px; text-align: left; }
#queueItemButton:hover { background: #292d2b; color: #fff; border-radius: 5px; }
...
QStatusBar { background: #151717; color: #747974; border-top: 1px solid #252828; font-size: 10px; }
